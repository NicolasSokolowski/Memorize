...
class UserController extends CoreController {
  ...
  signup = async (req, res) => {
    ...
    if (!password || !username || !email) {
      throw createMissingParamsError(
        req, {
          entityName: "user", 
          params: [
            "username", 
    ...
    if (!newUser) {
      throw createFailedCreationError(
        req, {
          entityName: "user"
        }
      );
  ...
  updateAccountInfo = async (req, res) => {
    ...
    if (isNotModified) {
      throw createUpdateNotModifiedError(
        req, {
          entityName: "user"
        }
      );
